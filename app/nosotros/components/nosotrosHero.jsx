...
export default function NosotrosHero() {
  return (
    <section className="bg-[url('/snosotros.jpg')] bg-top bg-cover bg-no-repeat h-[16rem] md:h-[22rem] py-5 relative after:content-[''] after:absolute after:inset-0 after:bg-black/65">
      <div className="contenedor relative z-10 text-white px-4 flex flex-col justify-center items-center h-full">
        ...
        <p className="text-center md:text-lg lg:text-xl ">
          Compromiso, calidad y experiencia en cada proyecto
        </p>
      </div>
    </section>
  );
