...
export default function ServiciosHero() {
  return (
    <section className="bg-[url('/heroservi.jpg')] bg-bottom bg-cover bg-no-repeat h-[16rem] md:h-[22rem] py-5 relative after:content-[''] after:absolute after:inset-0 after:bg-black/65">
      <div className="contenedor relative z-10 text-white px-4 flex flex-col justify-center items-center h-full">
        ...
        <p className="text-center md:text-lg lg:text-xl ">
          Soluciones confiables y de alta calidad para cada proyecto.
        </p>
      </div>
    </section>
  );
